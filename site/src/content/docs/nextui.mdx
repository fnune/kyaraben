...
- [ROM deletion protection](/collection/#protecting-roms-from-deletion) does not apply to this integration. It always follows ROM deletions, so deleting a ROM on another device removes it here too. Keep the device you treat as your library complete by leaving its protection on (the default).
