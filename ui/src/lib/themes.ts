...
export const themes: ThemeDefinition[] = [
  ...
  },
  {
    id: 'terminal',
    name: 'Terminal',
    description: 'Phosphor CRT, green on black',
    tokens: {
      surface: '#0a0e0a',
      surfaceAlt: '#0f180f',
      surfaceRaised: '#162016',
      onSurface: '#33ff33',
      onSurfaceSecondary: '#28cc28',
      onSurfaceMuted: '#1fa01f',
      onSurfaceDim: '#167016',
      onSurfaceFaint: '#0e480e',
      accent: '#00ff41',
      accentHover: '#33ff66',
      accentMuted: 'rgba(0, 255, 65, 0.08)',
      outline: '#1a2e1a',
      outlineStrong: '#244024',
      logoFilter:
        'brightness(0) saturate(100%) invert(65%) sepia(80%) saturate(500%) hue-rotate(85deg) brightness(1.1)',
      colorScheme: 'dark',
    },
  },
  {
